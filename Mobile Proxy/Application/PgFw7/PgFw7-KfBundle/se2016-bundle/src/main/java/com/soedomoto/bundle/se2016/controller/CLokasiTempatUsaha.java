...
public class CLokasiTempatUsaha {
    private static CLokasiTempatUsaha cLokasiTempatUsaha;
    public static CLokasiTempatUsaha instance() {
        if(cLokasiTempatUsaha == null) cLokasiTempatUsaha = new CLokasiTempatUsaha();
        return cLokasiTempatUsaha;
    }

    private Dao<MLokasiTempatUsaha, String> v510Dao;
    ...
    public Dao<MLokasiTempatUsaha, String> getV510Dao() {
        return v510Dao;
    }
        ...
        protected void doGet(HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
            ...
            actx.start(new Runnable() {
                public void run() {
                    try {
                        try {
                            List<MLokasiTempatUsaha> options = CLokasiTempatUsaha.instance().getV510Dao().queryForAll();
