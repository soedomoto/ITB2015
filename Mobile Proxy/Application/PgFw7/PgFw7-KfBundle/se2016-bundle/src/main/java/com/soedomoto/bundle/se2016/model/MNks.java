 ...
 */
@DatabaseTable(tableName = "nomor_kode_sampel")
public class MNks {
    ...
    public MNks(String fullKode, String kode, String nama, Date lastUpdate, MBlokSensus blokSensus) {
    ...
    public MNks(String kode, String nama, Date lastUpdate, MBlokSensus blokSensus) {
        this.kode = kode;
        this.nama = nama;
        this.blokSensus = blokSensus;
        this.fullKode = kode;
    ...
    public MNks(MBlokSensus blokSensus) {
        this.blokSensus = blokSensus;
    }
