 ...
 */
public class MTSPWithTimeWindows {
    private VehicleRoutingProblem.Builder vrpBuilder;

    public MTSPWithTimeWindows() {
    ...
    public void setLocations(String csvLocs) {
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                // Use flat service time for all locations
                builder.setServiceTime(1800.0);
    ...
    public static void main(String[] args) throws IOException {
        MTSPWithTimeWindows mtsp = new MTSPWithTimeWindows();
        ...
        AlgorithmSearchProgressChartListener progress = new AlgorithmSearchProgressChartListener(
                "output/mtsp_with_time_windows_progress.png");
        ...
        CSVWriter out = new CSVWriter(new FileWriter("output/mtsp_with_time_windows.csv"));
        ...
        new Plotter(problem, solution).plot("output/mtsp_with_time_windows.png","MTSP With Cost Matrix");
