...
public class CAccount {
    ...
    public void registerServlets(ServletContextHandler ctx) {
        ctx.addServlet(new ServletHolder(new Register()), Register.PATH);
        ctx.addServlet(new ServletHolder(new Login()), Login.PATH);
    }
    ...
    public void setAccountDao(Dao<MAccount, String> accountDao) {
