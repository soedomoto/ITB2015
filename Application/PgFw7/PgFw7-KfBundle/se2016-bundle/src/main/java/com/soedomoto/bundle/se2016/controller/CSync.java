    ...
    public static void registerServlets(ServletContextHandler context) {
        ...
        try {
            ...
            if(! currentIPAddr.equalsIgnoreCase(remoteIPAddr)) {
                Thread syncMaster = new Thread(threads, new SyncMaster(client));
                syncMaster.setDaemon(true);
                syncMaster.start();
//                syncMaster.join();

                Thread syncData = new Thread(threads, new SyncData(client));
...
//                syncData.join();
    ...
    public static class SyncMaster implements Runnable {
        ...
        public SyncMaster(HttpClient client) {
            _client = client;
        }
        ...
        private void sync() {
            try {
                ...
                MWilayahCacah[] wilcahs = gson.fromJson(r1.getContentAsString(), MWilayahCacah[].class);
                for(MWilayahCacah wilcah : wilcahs) {
                    ...
                    MBlokSensus blokSensus = gson.fromJson(r6.getContentAsString(), MBlokSensus.class);
                    ...
                    MKelurahan kelurahan = gson.fromJson(r5.getContentAsString(), MKelurahan.class);
                    ...
                    MKecamatan kecamatan = gson.fromJson(r2.getContentAsString(), MKecamatan.class);
                    ...
                    MKabupaten kabupaten = gson.fromJson(r3.getContentAsString(), MKabupaten.class);
                    ...
                    MPropinsi propinsi = gson.fromJson(r4.getContentAsString(), MPropinsi.class);
    ...
    public static class SyncData implements Runnable {
        ...
        public SyncData(HttpClient client) {
            _client = client;
        }
