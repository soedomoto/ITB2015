...
public class Validate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ErrorHandler error = new ErrorHandler(ruta);

        checkErrorRuta(ruta, error);
        for(ART art : ruta.getArts()) {
            checkErrorART(art, error);
        }
    ...
    private void checkErrorRuta(Ruta ruta, ErrorHandler error) {

    }

    private void checkErrorART(ART art, ErrorHandler error) {
