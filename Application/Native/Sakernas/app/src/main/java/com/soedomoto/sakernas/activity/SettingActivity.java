...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        osgiFrameworkBtn.setChecked(getProxyApplication().getKfOsgi().isStarted());
                ...
                if (isChecked) {
                    new AsyncTask<Void, Void, Exception>() {
                        ...
                        protected Exception doInBackground(Void... params) {
                            ...
                            try {
                                getProxyApplication().getKfOsgi().start();
            ...
            public void onClick(View v) {
                new AsyncTask<String, Void, Exception>() {
                    ...
                    protected Exception doInBackground(String... urls) {
                        ...
                        try {
                            org.osgi.framework.Bundle bundle = getProxyApplication().getKfOsgi().installBundle(urls[0]);
                            bundle.start();
                        } catch (BundleException e) {
                            ex = e;
                        }
