...
//        });
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Multimap<Integer, Object> entry = HashMultimap.create();

                entry.put(txtPropinsi.getId(), txtPropinsi.getText().toString());
                entry.put(txtKabupaten.getId(), txtKabupaten.getText().toString());
                entry.put(txtKecamatan.getId(), txtKecamatan.getText().toString());
